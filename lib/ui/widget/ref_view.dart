            ...
            SimpleDialogOption(
              ...
              onPressed: () {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(content: Text('>>No.${widget.refId}已复制到剪贴板中')),
                );
              },
            ),
            SimpleDialogOption(
                          ...
                          decoration: InputDecoration(
                            ...
                            label: Skeletonizer(
                              ...
                              effect: ShimmerEffect(
                                baseColor: Color.fromARGB(255, 123, 145, 69),
                              ),
                                    ...
                                    if (snapshot.data?.img != '')
                                      Padding(
                                        ...
                                        child: LongPressPreviewImage(
                                          ...
                                          imageHeroTag:
                                              widget.isThreadFirstOrForumPreview
                                              ? null
