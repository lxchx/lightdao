                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                              ...
                              Flexible(
                                fit: FlexFit.tight,
                                child: PopupMenuButton<image_picker.ImageSource>(
                                  icon: Icon(Icons.photo),
                                  onSelected:
                                      (image_picker.ImageSource source) async {
                                        try {
                                          // 如果是相机，需要请求相机权限
                                          if (source ==
                                  ...
                                  itemBuilder: (context) => [
                                    PopupMenuItem(
                                      value: image_picker.ImageSource.gallery,
                                      child: Row(
                                        children: [
                                    ...
                                    PopupMenuItem(
                                      value: image_picker.ImageSource.camera,
                                      child: Row(
                                        children: [
                                ...
                                if (pharseEditing)
                                  SliverReorderableGrid(
                                    ...
                                    onReorder: (oldIndex, newIndex) {
                                      appState.setState(
                                        (_) => setState(() {
                                          final Phrase item = phrases.removeAt(
                                            oldIndex,
                                          );
                                    ...
                                    itemBuilder: (context, index) => TextButton(
                                      onPressed: () {
                                        if (contentControler.selection.start !=
                                          ...
                                          contentControler
                                              .text = contentControler.text
                                              .replaceRange(
                                                contentControler
                                                    .selection
                                                    .start,
                                                null,
                                                phrases[index].value + lastPart,
                                              );
                                        } else {
                                          contentControler.text +=
                                              phrases[index].value;
